...
pca_meta = PCA(n_components=150, whiten=True, random_state=42)
...
meta_ctrl_test = np.zeros((n_ctrl_test, 150))
# Full test: treatment + control (aligned to test_features order)
X_test2_full = np.empty((len(test_features), X_trt.shape[1] + 150))
